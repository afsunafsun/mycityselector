...
class MycityselectorModelProvince extends Joomla\CMS\MVC\Model\ListModel
{
	 ...
	 * @return array
	 */
	public function getItems($countryId = null, $limit = true, $published = false)
	{
		if (empty($countryId))
		{
	...
	protected function getListQuery()
	{
        ...
        $query->select('a.id as id, a.country_id as country_id, c.name as name, a.subdomain as subdomain, a.published as published, a.ordering as ordering')
