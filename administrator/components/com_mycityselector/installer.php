...
class Pkg_mycityselectorInstallerScript {
    ...
    /**
     */
    function __construct(PackageAdapter $adapter)
    {
        // TODO Внимание!
        ...
        //
        // После установки данный скрипт перемещается в другую папку, откуда будет вызван при деинсталляции
        // administrator/manifests/packages/mycityselector/installer.php
        // administrator/manifests/packages/pkg_mycityselector.xml
    }
