...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_mycityselector&task=cities.saveOrderAjax&tmpl=component';
	\Joomla\CMS\HTML\HTMLHelper::_('sortablelist.sortable', 'cityList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
$colSpan = $clientId === 1 ? 8 : 10;
?>
<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_mycityselector&view=cities'); ?>" method="post" name="adminForm"
      id="adminForm">
			...
			<?php if ($this->total > 0) : ?>
                <table class="table table-striped" id="cityList">
                    ...
                    <tr>
                        ...
                        <th class="country">
		                    <?php echo \Joomla\CMS\HTML\HTMLHelper::_('searchtools.sort', 'COM_MYCITYSELECTOR_COUNTRY', 'country', $listDirn, $listOrder); ?>
                        </th>
                        <th class="province">
		                    <?php echo \Joomla\CMS\HTML\HTMLHelper::_('searchtools.sort', 'COM_MYCITYSELECTOR_PROVINCE', 'province', $listDirn, $listOrder); ?>
                        </th>
                        <th width="1%" class="nowrap center hidden-phone">
                        ...
                        <tr class="row<?php echo $i % 2; ?>"
                            ...
                            <td class="center">
                                <div class="btn-group">
									...
									?>
									<?php echo \Joomla\CMS\HTML\HTMLHelper::_('jgrid.published', $item->published, $i, 'cities.', $canChange, 'cb'); ?>
                                </div>
                            </td>
                            <td class="small">
                                <div class="name break-word">
									<?php if ($canEdit) : ?>
                                        <a href="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_mycityselector&task=city.edit&id=' . (int) $item->id); ?>"
